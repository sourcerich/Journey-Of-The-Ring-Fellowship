    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("History"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action ShowMenu("history")

            textbutton _("Save"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action ShowMenu("save")

        textbutton _("Load"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action ShowMenu("load")

        textbutton _("Options"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action ShowMenu("options")

        if _in_replay:

            textbutton _("End Replay"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action EndReplay(confirm=True)

        elif not main_menu:

            textbutton _("Main Menu"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action MainMenu()

        textbutton _("About"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action ShowMenu("about")
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            textbutton _("Help"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action ShowMenu("help")
        ...
        if renpy.variant("pc"):
            ...
            textbutton _("Quit"):
                hover_sound "audio/hover.mp3"
                activate_sound "audio/hover.mp3" action Quit(confirm=not main_menu)
